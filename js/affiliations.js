...
$.getJSON("json/affiliations.json", function (data) {
  ...
  $(document).ready(function () {
    autocompleteAffiliations("input-author-affiliation", "hiddenAuthorRorId", affiliationsData);
...
function autocompleteAffiliations(inputFieldId, hiddenFieldId, data) {
  ...
  if (!["input-author-affiliation", "inputCPAffiliation", "inputContributorAffiliation", "inputOrganisationAffiliation"].includes(inputFieldId)) {
