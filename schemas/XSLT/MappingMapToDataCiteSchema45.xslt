...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/">
		...
		<resource xmlns="http://datacite.org/schema/kernel-4">
			<xsl:attribute name="xsi:schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">http://datacite.org/schema/kernel-4 file:///C:/xampp/htdocs/mde-msl/schemas/DataCite/DataCiteSchema45.xsd</xsl:attribute>
			<xsl:for-each select="*[local-name()='Resource' and namespace-uri()='']">
							...
							<xsl:for-each select="*[local-name()='Affiliations' and namespace-uri()='']/*[local-name()='Affiliation' and namespace-uri()='']">
								...
								<affiliation>
									<xsl:attribute name="affiliationIdentifier" namespace="">
										<xsl:value-of select="concat('https://ror.org/', *[local-name()='rorId' and namespace-uri()=''])"/>
									</xsl:attribute>
				...
				<dates>
					...
					<xsl:for-each select="*[local-name()='SpatialTemporalCoverages' and namespace-uri()='']/*[local-name()='SpatialTemporalCoverage' and namespace-uri()='']">
						...
						<date>
							...
							<xsl:value-of select="concat(*[local-name()='dateTimeStart' and namespace-uri()=''], '/', *[local-name()='dateTimeEnd' and namespace-uri()=''])"/>
						</date>
					</xsl:for-each>
					<date>
				...
				<xsl:for-each select="(./*[local-name()='version' and namespace-uri()=''])[(string-length(string(.)) &gt; 0)]">
				...
				<geoLocations>
					<geoLocation>
						...
						<geoLocationPoint>
							<xsl:for-each select="(./*[local-name()='SpatialTemporalCoverages' and namespace-uri()='']/*[local-name()='SpatialTemporalCoverage' and namespace-uri()=''])[not(((((string-length(string(number(*[local-name()='longitudeMax' and namespace-uri()='']))) &gt; 0) and (string-length(string(number(*[local-name()='latitudeMax' and namespace-uri()='']))) &gt; 0)) and (number(*[local-name()='latitudeMax' and namespace-uri()='']) = number(*[local-name()='latitudeMax' and namespace-uri()='']))) and (number(*[local-name()='longitudeMax' and namespace-uri()='']) = number(*[local-name()='longitudeMax' and namespace-uri()='']))))]">
						...
						<geoLocationBox>
							<xsl:for-each select="(./*[local-name()='SpatialTemporalCoverages' and namespace-uri()='']/*[local-name()='SpatialTemporalCoverage' and namespace-uri()=''])[((((string-length(string(number(*[local-name()='longitudeMax' and namespace-uri()='']))) &gt; 0) and (string-length(string(number(*[local-name()='latitudeMax' and namespace-uri()='']))) &gt; 0)) and (number(*[local-name()='latitudeMax' and namespace-uri()='']) = number(*[local-name()='latitudeMax' and namespace-uri()='']))) and (number(*[local-name()='longitudeMax' and namespace-uri()='']) = number(*[local-name()='longitudeMax' and namespace-uri()=''])))]">
							...
							<xsl:for-each select="(./*[local-name()='SpatialTemporalCoverages' and namespace-uri()='']/*[local-name()='SpatialTemporalCoverage' and namespace-uri()=''])[((((string-length(string(number(*[local-name()='longitudeMax' and namespace-uri()='']))) &gt; 0) and (string-length(string(number(*[local-name()='latitudeMax' and namespace-uri()='']))) &gt; 0)) and (number(*[local-name()='latitudeMax' and namespace-uri()='']) = number(*[local-name()='latitudeMax' and namespace-uri()='']))) and (number(*[local-name()='longitudeMax' and namespace-uri()='']) = number(*[local-name()='longitudeMax' and namespace-uri()=''])))]">
								...
								<eastBoundLongitude>
									<xsl:value-of select="number(*[local-name()='longitudeMax' and namespace-uri()=''])"/>
								</eastBoundLongitude>
							</xsl:for-each>
							<xsl:for-each select="(./*[local-name()='SpatialTemporalCoverages' and namespace-uri()='']/*[local-name()='SpatialTemporalCoverage' and namespace-uri()=''])[((((string-length(string(number(*[local-name()='longitudeMax' and namespace-uri()='']))) &gt; 0) and (string-length(string(number(*[local-name()='latitudeMax' and namespace-uri()='']))) &gt; 0)) and (number(*[local-name()='latitudeMax' and namespace-uri()='']) = number(*[local-name()='latitudeMax' and namespace-uri()='']))) and (number(*[local-name()='longitudeMax' and namespace-uri()='']) = number(*[local-name()='longitudeMax' and namespace-uri()=''])))]">
							...
							<xsl:for-each select="(./*[local-name()='SpatialTemporalCoverages' and namespace-uri()='']/*[local-name()='SpatialTemporalCoverage' and namespace-uri()=''])[((((string-length(string(number(*[local-name()='longitudeMax' and namespace-uri()='']))) &gt; 0) and (string-length(string(number(*[local-name()='latitudeMax' and namespace-uri()='']))) &gt; 0)) and (number(*[local-name()='latitudeMax' and namespace-uri()='']) = number(*[local-name()='latitudeMax' and namespace-uri()='']))) and (number(*[local-name()='longitudeMax' and namespace-uri()='']) = number(*[local-name()='longitudeMax' and namespace-uri()=''])))]">
								...
								<northBoundLatitude>
									<xsl:value-of select="number(*[local-name()='latitudeMax' and namespace-uri()=''])"/>
								</northBoundLatitude>
							</xsl:for-each>
						</geoLocationBox>
					</geoLocation>
